...
const RegisterPage = () => {
  ...
  const [username, setUsername] = useState(''); // Replace matricNumber with username
  ...
  const handleUsernameChange = (e) => { // Replace matricNumber change handler with username
  ...
  const handleSubmit = async (e) => {
    ...
    if (isValid) {
      try {
        ...
        const dataToSend = {
          name,
          username, // Replace matricNumber with username
          email,
          password,
        };
      ...
      <div className="container mx-auto mt-8 p-4">
        ...
        >
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label htmlFor="username" className="block text-gray-700 font-semibold mb-2">Matriculation Number:</label> {/* Replace matricNumber label with username */}
              <input
                  type="text"
                  id="username"
                  className={`w-full px-3 py-2 border rounded-md ${errors.username && 'border-red-500'}`} // Replace matricNumber input with username
                  value={username}
                  onChange={handleUsernameChange} // Replace matricNumber change handler with username
              />
