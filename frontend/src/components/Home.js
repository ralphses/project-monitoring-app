...
const Home = () => {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-blue-100 to-purple-200 p-4">
            ...
            >
                Welcome to the Student-Supervisor Collaboration Platform
            </motion.h1>
            <motion.p
            ...
            >
                A seamless way for supervisors to guide students in writing their projects.
            </motion.p>
            <motion.p
                className="text-md md:text-lg lg:text-xl text-center text-gray-600 mb-8"
                initial={{ opacity: 0, y: 50 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.3 }}
            >
                Collaborate, track progress, and ensure your projects are on the right path.
            </motion.p>
